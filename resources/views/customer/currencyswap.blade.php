                        ...
                        <div style="display:flex; width: 100%;">
                            ...
                            <div class="p-2 linear">
                               ...
                               sans-serif; font-size: 15px;">
                                    {{-- {{ ucwords(str_replace("-"," ",$plan->type)) }} {{ ($key+1) }} 
                                    <b>({{ ($plan->currency) }})</b> --}}here
                                </p>
                                <p class="my-1 p-1 d-flex rounded">
                                    <span style="flex: 1; ">Min:</span>
                                    <b>
                                        {{-- {{ ($plan->currency == "USD") ? number_format($plan->min,0,".",",") : $plan->min }} {{ $plan->currency }} --}}her
                                    </b>
                                </p>
                                <p class="my-1 p-1 d-flex rounded">
                                    <span style="flex: 1; ">Max:</span>
                                    <b>
                                        {{-- {{ ($plan->currency == "USD") ? number_format($plan->max,0,".",",") : $plan->max }} {{ $plan->currency }} --}}here
                                    </b>
                                </p>
                                <p class="my-1 p-1 d-flex rounded">
                                ...
                                <div class="flex:2">
                                    {{-- <span id="error{{ $key }}" class="text-danger"></span> --}}here
                                 </div>
