                            ...
                            <div class="buysell wide-xs m-auto">
                                ...
                                <div class="buysell-title text-center">
                                    <p class="title">Withdrawal of funds from your
                                         {{-- {{ ucwords(strtolower(config("app.name"))) }} --}}
                                          account balance is available using 5 payment systems - BTC, ETH, LTC, USDT, Perfect Money. Select the account then select the payment system to which you want to withdraw funds, enter the withdrawal amount and click the "Withdraw".</p>
                                ...
                                <div class="buysell-block">
                                        ...
                                        <div class="buysell-field form-group">
                                            ...
                                            <div class="form-control-group">
                                                <select  name="currency" id="currency" class="charge_account  form-control  form-control-number">
                                                   here {{-- <option data-balance="{{ $account->dolla_balance }}" value="USD" class="small"></i>USD</option>
                                        ...
                                        <div class="buysell-field form-group">
                                            ...
                                            <div class="form-control-group">
                                                <select  class="payment_account form-control form-select  form-control-number">
                                                    {{-- @if (!empty($account->perfectmoney_address)) --}}here
                                                    <option value="Perfect-Money">Perfect Money</option>
                                                    {{-- @endif --}}
                                                    {{-- @if (!empty($account->bitcoin_address)) --}}here
                                                    <option value="BTC">BTC</option>
                                                    {{-- @endif --}}
                                                    {{-- @if (!empty($account->usdt_address )) --}}here
                                                    <option value="USDT">USDT</option>
                                                    {{-- @endif --}}
                                                    {{-- @if (!empty($account->ethereum_address)) --}}here
                                                    <option value="ETH">ETH</option>
                                                    {{-- @endif --}}
                                                    {{-- @if (!empty($account->litecoin_address)) --}}here
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-12 col-lg-12 py-3 ">
                                                <button 
                                                {{-- data-url="{{ route("user.withdraw.view") }}" class="btn btn-primary btn-block process_withdraw" --}}
                                                > here
                                                    Withdraw
                                                </button>
                                            </div>
