                                                  ...
                                                  <div class="price-plan card card-bordered text-center">
                                                      <div class="card-inner">
                                                          <div class="price-plan-media">
                                                             here {{-- <img src="{{ asset("assets/images/plans/".random_int(1,5).".svg") }}" alt=""> --}}
                                                          </div>
                                                          ...
                                                          <div class="price-plan-amount">
                                                           ...
                                                           here {{-- @if (ucwords(str_replace(["swap","-"],"",$plan->type)) != "Currency") --}}
                                                            <div 
                                                            class="bill">
                                                           here {{-- Type - {{ strtoupper(str_replace(["swap","-"],"",$plan->type)) }} --}}here
                                                            <span></span>
                                                        </div>
                                                            {{-- @endif --}}
                                                     
                                                              <div class="bill">
                                                                 here {{-- Min - {{ ($plan->currency == "USD") ? number_format($plan->min,0,".",",") : $plan->min }} {{ $plan->currency }} --}}
                                                                  <span></span></div>
                                                              ...
                                                              <div class="bill">
                                                                 here {{-- Max - {{ ($plan->currency == "USD") ? number_format($plan->max,0,".",",") : $plan->max }} {{ $plan->currency }} --}}
                                                                  <span></span></div>

                                                              <div class="bill">
                                                                  here{{-- Duration - {{ ucwords($plan->duration) }} --}}
                                                                  <span></span></div>
                                                              <div class="bill">
                                                                  here{{-- Commission - {{ ucwords($plan->commission) }}% --}}
                                                                  <span></span></div>
                                                              <div class="bill">
                                                                 here {{-- Currency - {{ $plan->currency }} --}}
                                                                  <span></span></div>
                                                          ...
                                                          <div class="price-plan-action">
                                                              <input style="border:2px solid #526484;border-radius:12px;"  class="form-control investment_amount" placeholder="Enter Amount " 
                                                              {{-- id="input{{ $key }}"  
                                                              data-btn="btn{{ $key }}"  --}}
                                                              type="number" name="" placeholder="0.00" >

                                                              <span 
                                                              {{-- class="text-danger error_box d-block mt-1 mb-1" id="error{{ $key }}" --}}
                                                              >here
                                                            </span>
