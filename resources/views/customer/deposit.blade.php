...
<body class="nk-body npc-crypto has-sidebar has-sidebar-fat ui-clean ">
                ...
                <div class="modal-body modal-body-lg">
                    ...
                    <div class="nk-block">
                        <div class="buysell-field form-action text-center">
                            <div> --}}
                                {{-- <a href="#" class="btn btn-primary mt-4 btn-lg confirm_deposit" data-url="
                                {{-- {{ route("user.deposit.confirm.post") }} --}}
                                {{-- ">Confirm
                                    Payments</a>
                            </div>
                        </div>
    ...
    {{-- <script>
        ...
        <script src="{{ asset('assets/js/custom_dropzone.js') }}"></script> --}} here
    <!-- END PAGE CONTAINER-->
</body>
