                       ...
                       <div class="card card-bordered card-preview">
                        <div class="card-inner">
                         <div class="preview-block">
                          ...
                          <div class="">
                           <form action="
                           {{-- {{ route("user.setting.view",["payment"]) }} --}}
                           " method="POST">
                            {{-- @csrf --}}
                            <div class="row">
                              <div class="col-sm-12  form-row">
                                {{-- @if (!empty($success)) --}}here
                                <span class="info_box text-success">
                                  {{-- {{ $success }} --}}here
                                </span>
                                {{-- @endif --}}
                              </div>
                              ...
                              <div class="col-sm-12  form-row">
                                {{-- @if (!empty($error)) --}}here
                                <span class="info_box text-danger">
                                  {{-- {{ $error }} --}}here
                                </span>
                                {{-- @endif --}}
                              </div>
                            ...
                            <div class="col-sm-6 col-md-12 mb-2">
                             <div class="form-group">
                              ...
                              <div class="form-control-wrap">
                               <input  type="text"  class="form-control" name="bitcoin_address"  value="
                            ...
                            <div class="col-sm-6 col-md-12 mb-2">
                                <div class="form-group">
                                 ...
                                 <div class="form-control-wrap">
                                  <input  type="text"  class="form-control" name="ethereum_address"  value="
                               ...
                               <div class="col-sm-6 col-md-12 mb-2">
                                <div class="form-group">
                                 ...
                                 <div class="form-control-wrap">
                                  <input  type="text"  class="form-control" name="litecoin_address"  value="
                                  {{-- {{ $account->litecoin_address }} --}}
                               ...
                               <div class="col-sm-6 col-md-12 mb-2">
                                <div class="form-group">
                                 ...
                                 <div class="form-control-wrap">
                                  <input  type="text"  class="form-control" name="perfectmoney_address"  value="
                                  {{-- {{ $account->perfectmoney_address }} --}}
                                  " placeholder="Enter perfectmoney address">
                                 </div>
                               ...
                               <div class="col-sm-6 col-md-12 mb-2">
                                <div class="form-group">
                                 ...
                                 <div class="form-control-wrap">
                                  <input  type="text"  class="form-control" name="usdt_address"  value="
                                  {{-- {{ $account->usdt_address }} --}}
                               ...
                               <div class="col-sm-6 col-md-12 mb-2">
                                <div class="form-group">
                                 ...
                                 <div class="form-control-wrap">
                                  <input  type="text"  class="form-control" name="transaction_pin"  value="
