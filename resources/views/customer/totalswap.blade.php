                        ...
                        <div style="display:flex; width: 100%;">
                            ...
                            <div class="p-2 linear">
                               ...
                               sans-serif; font-size: 15px;">
                                 here   {{-- {{ ucwords(str_replace("-"," ",$plan->type)) }} {{ ($key+1) }}  --}}
                                    <b>
                                      here  {{-- ({{ ($plan->currency) }}) --}}
                                    </b>
                                </p>
                                <p class="my-1 p-1 d-flex rounded">
                                    ...
                                    <b>
                                      here  {{-- {{ ($plan->currency == "USD") ? number_format($plan->min,0,".",",") : $plan->min }} {{ $plan->currency }} --}}
                                    </b>
                                </p>
                                <p class="my-1 p-1 d-flex rounded">
                                    <span style="flex: 1; ">Max:</span>
                                    <b>
                                      here  {{-- {{ ($plan->currency == "USD") ? number_format($plan->max,0,".",",") : $plan->max }} {{ $plan->currency }} --}}
                                    </b>
                                </p>
                                <p class="my-1 p-1 d-flex rounded">
                                    <span style="flex: 1; ">Days:</span>
                                    <b>
                                       here {{-- {{ ucwords($plan->duration) }} --}}
                                    </b>
                                </p>
                                <p class="my-1 p-1 d-flex rounded">
                                ...
                                <div class="flex:2">
                                   here {{-- <span id="error{{ $key }}" class="text-danger"></span> --}}
                                 </div>
                                <div class="mb-2 py-2 d-flex">
                                    ...
                                    <div style="flex:1;">
                                       ...
                                       here {{-- <input id="input{{ $key }}"  data-btn="btn{{ $key }}" type="number" name="" placeholder="0.00" class="rounded form-control py-2 investment_amount"> --}}
                                    </div>
                                    <div class="ml-2">
                                        <button 
                                        {{-- disabled="true"
