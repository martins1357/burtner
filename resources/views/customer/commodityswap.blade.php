        ...
        <div class="section__content section__content--p30 resize">
            <div class="container-fluid">
                <div class="row pb-4 lead-blocks">
                    ...
                    {{-- @foreach ($plans as $key => $plan)  --}}here
                        ...
                        <div style="display:flex; width: 100%;">
                            ...
                            <div class="p-2 linear">
                               ...
                               sans-serif; font-size: 15px;">
                                      {{-- {{ ucwords(str_replace("-"," ",$plan->type)) }} {{ ($key+1) }}  --}}here
                                    {{-- <b>
                                         ({{ ($plan->currency) }})  
                                ...
                                <p class="my-1 p-1 d-flex rounded">
                                    ...
                                    {{-- <b>
                                     {{ ($plan->currency == "USD") ? number_format($plan->min,0,".",",") : $plan->min }} {{ $plan->currency }}  
                                    </b> --}}
                                </p>
                                <p class="my-1 p-1 d-flex rounded">
                                    <span style="flex: 1; ">Max:</span>
                                    {{-- <b>
                                 {{ ($plan->currency == "USD") ? number_format($plan->max,0,".",",") : $plan->max }} {{ $plan->currency }} 
