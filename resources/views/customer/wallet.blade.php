                                        ...
                                        <div class="nk-wg1 mb-3">
                                            <div class="nk-wg1-group g-2">
                                                <div class="nk-wg1-item mr-xl-4">
                                                    <div class="nk-wg1-title text-light">Dollar Balance / <div class="dropdown">
                                                            <a class="text-light" data-offset="0,10" href="javascript:void(0)">USD</a>
                                                        </div>
                                                    </div>
                                                    <div class="nk-wg1-amount">
                                                        <div class="amount text-light">
                                                        here    {{-- ${{ number_format($wallet->dolla_balance,0,".",",") }} --}}
                                                        </div>
                                                    </div>
                                                </div><!-- .nk-wg1-item -->
                                                <div class="nk-wg1-item mr-xl-4">
                                                    <div class="nk-wg1-title text-light">Bitcoin Balance / <div class="dropdown">
                                                            <a class="text-light" data-offset="0,10" href="javascript:void(0)">BTC</a>
                                                        </div>
                                                    </div>
                                                    <div class="nk-wg1-amount">
                                                        <div class="amount text-light">
                                                          here  {{-- {{ $wallet->bitcoin_balance }}  --}}
                                                        </div>
                                                    </div>
                                                    
                                                </div><!-- .nk-wg1-item -->
                                                <div class="nk-wg1-item mr-xl-4">
                                                    <div class="nk-wg1-title text-light">Ethereum Balance / <div class="dropdown">
                                                            <a class="text-light" data-offset="0,10" href="javascript:void(0)">ETH</a>
                                                        </div>
                                                    </div>
                                                    <div class="nk-wg1-amount">
                                                        <div class="amount text-light">
                                                            {{-- {{ $wallet->ethereum_balance }}  --}}here
                                                        </div>
                                                    </div>
                                                </div><!-- .nk-wg1-item -->
                                                <div class="nk-wg1-item mr-xl-4">
                                                    <div class="nk-wg1-title text-light">Referral Balance / <div class="dropdown">
                                                            <a class="text-light" data-offset="0,10" href="javascript:void(0)">USD</a>
                                                        </div>
                                                    </div>
                                                    <div class="nk-wg1-amount">
                                                        <div class="amount text-light">
                                                            {{-- ${{ number_format($wallet->referral_balance,0,".",",") }} --}}here
                                                        </div>
                                                    </div>
                                                </div><!-- .nk-wg1-item -->
                                                    ...
                                                    <div class="nk-wg1-group g-2">
                                                        <div class="nk-wg1-sub">
                                                            <div class="sub-text"><span>USD Deposit</span>
                                                                <div class="dot" data-bg="#9cabff" style="background: rgb(156, 171, 255) none repeat scroll 0% 0%;"></div>
                                                            </div>
                                                            <div class="lead-text  text-light">
                                                            here    {{-- ${{ number_format($wallet->deposits ,0,".",",") }} --}}
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="nk-wg1-sub">
                                                            ...
                                                            <div class="lead-text  text-light">
                                                             here   {{-- ${{ number_format($wallet->dolla_withdrawals ,0,".",",") }} --}}
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="nk-wg1-sub">
                                                            ...
                                                            <div class="lead-text  text-light">
                                                             here   {{-- {{ $wallet->bitcoin_withdrawals }} --}}
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="nk-wg1-sub">
                                                            ...
                                                            <div class="lead-text  text-light">
                                                             here   {{-- {{ $wallet->ethereum_withdrawals }} --}}
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="nk-wg1-sub">
                                                            ...
                                                            <div class="lead-text  text-light">
                                                              here  {{-- ${{ number_format($wallet->dolla_invested ,0,".",",") }} --}}
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="nk-wg1-sub">
                                                            ...
                                                            <div class="lead-text  text-light">
                                                               here {{-- ${{ number_format($wallet->dolla_earned ,0,".",",") }} --}}
                                                            </div>
                                                        </div>
