                       ...
                       <div class="card card-bordered card-preview">
                        <div class="card-inner">
                         <div class="preview-block">
                          ...
                          <div class="">
                           <form action="
                           {{-- {{ route("user.setting.view",["general"]) }} --}}
                           " method="POST">
                            {{-- @csrf --}}
                            <div class="row">
                            ...
                            <div class="col-sm-6 col-md-12 mb-2">
                             <div class="form-group">
                              ...
                              <div class="form-control-wrap">
                               ...
                               {{-- {{ !empty(old("firstname")) ? old("firstname") : $user->firstname }} --}}
                            ...
                            <div class="col-sm-6 col-md-12 mb-2">
                              <div class="form-group">
                               ...
                               <div class="form-control-wrap">
                                ...
                                {{-- {{ !empty(old("lastname")) ? old("lastname") : $user->lastname }} --}}
                             ...
                             <div class="col-sm-6 col-md-12 mb-2">
                              <div class="form-group">
                               ...
                               <div class="form-control-wrap">
                                ...
                                {{-- {{ !empty(old("username")) ? old("username") : $user->username }} --}}
                             ...
                             <div class="col-sm-6 col-md-12 mb-2">
                              <div class="form-group">
                               ...
                               <div class="form-control-wrap">
                                ...
                                {{-- {{ !empty(old("email")) ? old("email") : $user->email }} --}}
                             ...
                             <div class="col-sm-6 col-md-12 mb-2">
                              <div class="form-group">
                               ...
                               <div class="form-control-wrap">
                                <input required="" type="phone"  class="form-control" name="phone"  value="
                                {{-- {{ !empty(old("phone")) ? old("phone") : $user->phone }} --}}
