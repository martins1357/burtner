            ...
            <div class="nk-sidebar-content">
                ...
                <div class="nk-sidebar-menu">
                    ...
                    <ul class="nk-menu">
                        ...
                        <li class="nk-menu-item">
                             <a href="
                            {{ route('user.deposit.view') }}
                            
                             " class="nk-menu-link"> 
                                <span class="nk-menu-icon">
                                    <em class="icon ni ni-wallet-in"></em></span>
                        ...
                        <li class="nk-menu-item">
                             <a href="
                             {{ route('user.conversion.view') }}  
                            " class="nk-menu-link"> 
                                <span class="nk-menu-icon">
                                    <em class="icon ni ni-meter"></em></span>
