                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="tb-tnx-action">
                                                                        {{-- <a title="approve" data-action="approve" data-type="withdraw" class="decline_approve" href="{{ route("admin.withdraw.view",["approve",$data->id]) }}"><em class="icon ni ni-check-c"></em></a> --}}

                                                                        {{-- <a title="delete" data-action="delete" class="delete_data text-danger" href="{{ route("admin.withdraw.view",["delete",$data->id]) }}" data-type="withdraw" ><em  class="icon ni ni-trash-fill "></em></a> --}}

                                                                        {{-- <a title="decline" data-action="decline" data-type="withdraw" class="decline_approve" href="{{ route("admin.withdraw.view",["decline",$data->id]) }}"><em class="icon ni ni-cross-fill-c"></em></a> --}}
                                                                  </td>
                                                                </tr>
                                                                {{-- @endforeach --}}
                                                            </tbody>
